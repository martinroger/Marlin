...
#define STRING_CONFIG_H_AUTHOR "Martin ROGER" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Jiggly-wiggly"
...
// FLAG : Not sure if we should use it at Danecca ?
 ...
 */
#define S_CURVE_ACCELERATION //FLAG activated on current TH3D
...
#define X_BED_SIZE 500 // Example configuration file suggests 510
#define Y_BED_SIZE 500 // Example configuration file suggests 510
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR //FLAG Disabled as long as it is not repaired
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define NUM_RUNOUT_SENSORS   1     // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  #define FIL_RUNOUT_INVERTING true // set to true to invert the logic of the sensor.
  #define FIL_RUNOUT_PULLUP          // Use internal pullup for filament runout pins.
  //#define FIL_RUNOUT_PULLDOWN      // Use internal pulldown for filament runout pins.
  //#define FIL_RUNOUT_PIN 2//Not needed to uncomment. Make sure it is connected to X-MAX
