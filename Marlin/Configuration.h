...
#define STRING_CONFIG_H_AUTHOR "MRR, Ender3+SKR1.3" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "EnSKR 3"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION (max(X_PROBE_OFFSET_FROM_EXTRUDER,50))
